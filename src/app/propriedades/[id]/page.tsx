...
interface PropertyDetailPageProps {
  params: {
    id: string // Corrected: params is directly the object, not a Promise
  }
}
    ...
    return (
      <div className="min-h-screen bg-[#181818] text-white pt-[76px] overflow-x-hidden">
        ...
        <main className="px-6 lg:px-36 py-12 text-center">
          ...
          <p className="text-[#a0a0a0] text-lg">A propriedade que você está procurando não existe ou foi removida.</p>
        </main>
        <Footer />
      </div>
    )
