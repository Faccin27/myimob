          ...
          >
            <div className="flex justify-between items-center mb-6">
              <Link href={"/"} className="flex items-center gap-2" onClick={() => setIsMobileMenuOpen(false)}>
                <Image src="/images/logo.png" alt="Urbane Logo" width={40} height={40} className="w-10 h-10" />
                <span className="text-2xl font-bold text-[#ffffff]">Myimob</span>
              </Link>
            </div>
                ...
                <SheetClose asChild key={item.id}>
                  <Link
                    ...
                    className={cn(
                      ...
                      activeSection === item.id ? "bg-[#2a2a2a] text-[#3655d4]" : "text-[#a0a0a0]",
                    )}
